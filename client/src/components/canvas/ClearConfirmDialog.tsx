...
export const ClearConfirmDialog: React.FC<ClearConfirmDialogProps> = React.memo(({
  ...
  return (
    <Modal
      ...
      description="This will clear the canvas for all collaborators currently in this room."
    >
      <div className="space-y-4">
        <p className="text-xs text-slate-500">
          This action affects everyone in the room. You can still revert it using Undo (<kbd className="font-mono bg-slate-100 px-1 py-0.5 rounded border border-slate-200 text-slate-700">Ctrl+Z</kbd>).
        </p>
